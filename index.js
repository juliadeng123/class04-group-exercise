...
var containerOne = 50;
containerOne = containerOne + 5; //55
var containerTwo = 20;
containerTwo = containerTwo - 10; //10
var total = (containerOne + containerTwo)/2; // 32.5
...
var litreTwo = 2;
var litreThree = 5.5;
var total = (litreOne + litreTwo + litreThree)/3; //3
console.log(total); //3
...
var total = (centimeterOne + centimeterTwo + centimeterThree)/3; //5.67
...
var caseTwo = 30;
var caseThree = 35;
var total = (caseOne + caseTwo + caseThree)/3 //25
...
var boxThree = 6;
var boxFour = 9;
var total = (boxOne + boxTwo + boxThree + boxFour)/4 //5.5
...
/** Example
 * initialise the variable `bottles` to the value of 5
 * increment bottles by 1
 * initialise the variable `cans` to the value of 6
 * initialise total to the total of bottles and cans
 * console log the total. Write a single line comment as to what will be displayed
 */
var bottles = 5;
bottles = bottles + 1; //6
var cans = 6;
var total = (bottles + cans); // 12
...
/** Example
 * initialise the variable `car one` to the value of 10 000
 * increment car one by 1000
 * initialise the variable `car two` to the value of 12000
 * initialise total to the average of car one and car two
 * console log the total. Write a single line comment as to what will be displayed
 */
var carOne = 10000;
carOne = carOne + 1000; //11 000
var carTwo = 12000;
var total = (carOne + carTwo)/2; //11500
console.log(total); //11500
...
/** Question 11
 * initialise the variable `age one` to the value of 15
 * initialise the variable `age two` to the value of 23
 * initialise the variable `age three` to the value of 40
 * initialise total to the average of all the ages
 * console log the total. Write a single line comment as to what will be displayed
 */
var ageOne = 15;
var ageTwo = 23;
var ageThree = 40;
var total = (ageOne + ageTwo + ageThree)/3; //26
